//
//  NSJSONSerialization+XLJSONSerialization.m
//  XLMailBoxContainer
//
...
@implementation XLJSONSerialization


@synthesize postsData = _postData;

+ (instancetype)sharedInstance
{
    static XLJSONSerialization * _sharedInstance = nil;
